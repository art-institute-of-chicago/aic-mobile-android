...
import edu.artic.info.databinding.FragmentInformationBinding
...
class InformationFragment :
    BaseViewModelFragment<FragmentInformationBinding, InformationViewModel>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (BuildConfig.IS_RENTAL) {
            with(binding) {
                purchaseTicketsForAdmission.text =
                    context?.getString(R.string.info_purchase_tickets_rental_prompt)
    ...
    override fun setupBindings(viewModel: InformationViewModel) {
        ...
        binding.appBarLayout.setOnSearchClickedConsumer(Consumer { viewModel.onClickSearch() })
        ...
        binding.museumInformation.clicks()
            .defaultThrottle()
            .subscribeBy {
        ...
        binding.locationSettings.clicks()
            .defaultThrottle()
            .subscribeBy {
        ...
        viewModel.buildVersion
            .subscribeBy { versionName ->
                binding.versionInfo.text = getString(R.string.info_version, versionName)
            }
            .disposedBy(disposeBag)
        ...
        viewModel.generalInfo
            ...
            .subscribeBy {
                binding.appBarLayout.setSubtitleText(it.infoSubtitle)
                requestTitleUpdate(it.infoTitle)
            }
            .disposedBy(disposeBag)

        binding.accessMemberCard.clicks()
            .defaultThrottle()
            .subscribe {
        ...
        binding.languageSettings.clicks()
            .defaultThrottle()
            .subscribe {
