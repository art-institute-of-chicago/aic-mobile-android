...
class InfoLocationSettingsFragment :
    BaseViewModelFragment<FragmentLocationSettingsBinding, InfoLocationSettingsViewModel>() {
    override val viewModelClass: KClass<InfoLocationSettingsViewModel> =
        InfoLocationSettingsViewModel::class
    ...
    override fun setupBindings(viewModel: InfoLocationSettingsViewModel) {
        ...
        viewModel.buttonType
            ...
            .bindToMain(binding.locationSettingsButton.text())
            .disposedBy(disposeBag)

        binding.locationSettingsButton
            .clicks()
            .subscribe {
