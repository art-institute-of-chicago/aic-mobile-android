...
import edu.artic.media.ui.databinding.ActivityAudioTutorialBinding
...
class AudioTutorialActivity :
    BaseViewModelActivity<ActivityAudioTutorialBinding, AudioTutorialViewModel>() {
